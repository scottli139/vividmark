  ...
  useTranslation: () => ({
    t: (key: string, options?: Record<string, string | number>) => {
      ...
      const translations: Record<string, string> = {
        ...
        'menu.exportSite': 'Export as Site…',
        'menu.settings': 'Settings…',
        'menu.exit': 'Exit',
        'menu.pastePlain': 'Paste as Plain Text',
        'menu.find': 'Find…',
        'menu.table': 'Table…',
        'menu.image': 'Image…',
        'menu.admonition': 'Admonition…',
        'menu.theme': 'Theme',
        'menu.zoomIn': 'Zoom In',
        'menu.zoomOut': 'Zoom Out',
        'menu.zoomReset': 'Actual Size',
        'menu.fullscreen': 'Fullscreen',
        'menu.about': 'About VividMark',
        'about.title': 'About VividMark',
        'about.version': `Version ${options?.version ?? ''}`,
        'about.copyright': 'Copyright © 2025 Scott Li',
