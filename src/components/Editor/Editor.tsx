...
export function Editor() {
  ...
  if (viewMode === 'wysiwyg') {
    return (
      <div
        className={`flex-1 flex flex-col items-center justify-center ${isDarkMode ? 'dark' : ''}`}
      >
        <div className="text-center p-8">
          <div className="mb-4">
            <svg
              className="w-16 h-16 mx-auto text-[var(--accent-color)]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <p className="text-[var(--text-secondary)] mb-4">
            Coming soon! This mode will allow you to edit rendered content directly.
          </p>
          <button
